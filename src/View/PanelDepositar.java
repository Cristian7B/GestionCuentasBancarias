...
public class PanelDepositar extends JPanel {
    ...
    public void inicializarComponentes() {
        ...
        valorARetirar = new JLabel("Valor a depositar");
        ...
        registrarCuenta = new JButton("Depositar");
        registrarCuenta = PanelButtons.crearBotonEstilizado("Depositar");
        registrarCuenta.setActionCommand("Depositar Cuenta");

        botonAtras = new JButton("Atras");
        botonAtras = PanelButtons.crearBotonEstilizado("Atras");
        botonAtras.setBackground(new Color(0xF40000));
        botonAtras.setActionCommand("Atras Depositar");
        ...
        titulo = new JLabel("¡Deposita dinero de una cuenta!");
